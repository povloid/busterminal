...
/**
 * JUnit test service class for entity class: DocumentType
...
public class TestDocumentTypeService {
	...
	public void testGetAllEntitiesSingularAttributeOfTQSortOrderType()
		...
		List<DocumentType> list = service.getAllEntities(DocumentType_.id, SortOrderType.ASC);
	...
	public void testGetAllEntitiesIntIntSingularAttributeOfTQSortOrderType()
		...
		List<DocumentType> list = service.getAllEntities(10, 10, DocumentType_.id,
				SortOrderType.ASC);
	...
	public void testGetAllEntitiesBooleanIntIntSingularAttributeOfTQSortOrderType()
		...
		// all - FALSE
		List<DocumentType> list = service.getAllEntities(false, 10, 10, DocumentType_.id,
				SortOrderType.ASC);
