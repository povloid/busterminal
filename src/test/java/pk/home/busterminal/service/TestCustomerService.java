...
/**
 * JUnit test service class for entity class: Customer Customer - клиент
 */
...
public class TestCustomerService {
	 ...
	 */
	@Autowired
	public void setDataStore(CustomerService service) {
	...
	public void testGetAllEntities() throws Exception {
		...
		List<Customer> list = service.getAllEntities();
	...
	public void testGetAllEntitiesSingularAttributeOfTQSortOrderType()
		...
		List<Customer> list = service.getAllEntities(Customer_.id,
				SortOrderType.ASC);
	...
	public void testGetAllEntitiesIntInt() throws Exception {
		...
		List<Customer> list = service.getAllEntities(10, 10);
	...
	public void testGetAllEntitiesIntIntSingularAttributeOfTQSortOrderType()
		...
		List<Customer> list = service.getAllEntities(10, 10, Customer_.id,
				SortOrderType.ASC);
	...
	public void testGetAllEntitiesBooleanIntIntSingularAttributeOfTQSortOrderType()
		...
		// all - FALSE
		List<Customer> list = service.getAllEntities(false, 10, 10,
				Customer_.id, SortOrderType.ASC);
		...
		// all - TRUE
		list = service.getAllEntities(true, 10, 10, Customer_.id,
				SortOrderType.ASC);
	...
	public void testFind() throws Exception {
		...
		customer.setnName("Имя - ТЕСТ");
		customer.setmName("Отчество - ТЕСТ");
		customer = service.persist(customer);

		long id = customer.getId();

		Customer customer2 = service.find(id);
	...
	public void testRefresh() throws Exception {
		...
		customer2 = service.refresh(customer2);
	...
	public void testMerge() throws Exception {
		...
		customer2.setKeyName("key 65535");
		customer2 = service.merge(customer2);

		customer = service.refresh(customer);
	...
	public void testRemove() throws Exception {
		...
		Customer customer3 = service.find(id);
