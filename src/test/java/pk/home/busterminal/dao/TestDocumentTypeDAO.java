...
/**
 * JUnit test DAO class for entity class: DocumentType DocumentType - тип
 * документа
 */
...
public class TestDocumentTypeDAO {
	...
	public void testGetAllEntitiesSingularAttributeOfTQSortOrderType()
		...
		List<DocumentType> list = dataStore.getAllEntities(DocumentType_.id,
				SortOrderType.ASC);
	...
	public void testGetAllEntitiesBooleanIntIntSingularAttributeOfTQSortOrderType()
		...
		// all - FALSE
		List<DocumentType> list = dataStore.getAllEntities(false, 10, 10,
				DocumentType_.id, SortOrderType.ASC);
