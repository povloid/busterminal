...
/**
 * JUnit test DAO class for entity class: SeatType SeatType - тип места
 */
...
public class TestSeatTypeDAO {
	...
	public void testGetAllEntitiesSingularAttributeOfTQSortOrderType()
		...
		List<SeatType> list = dataStore.getAllEntities(SeatType_.id,
				SortOrderType.ASC);
	...
	public void testGetAllEntitiesBooleanIntIntSingularAttributeOfTQSortOrderType()
		...
		// all - FALSE
		List<SeatType> list = dataStore.getAllEntities(false, 10, 10,
