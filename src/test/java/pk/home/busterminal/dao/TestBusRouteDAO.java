...
/**
 * JUnit test DAO class for entity class: BusRoute BusRoute - Маршрут
 */
...
public class TestBusRouteDAO {
	...
	public void testGetAllEntitiesSingularAttributeOfTQSortOrderType()
		...
		List<BusRoute> list = dataStore.getAllEntities(BusRoute_.id,
				SortOrderType.ASC);
	...
	public void testGetAllEntitiesBooleanIntIntSingularAttributeOfTQSortOrderType()
		...
		// all - FALSE
		List<BusRoute> list = dataStore.getAllEntities(false, 10, 10,
