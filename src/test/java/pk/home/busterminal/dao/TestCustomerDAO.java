...
/**
 * JUnit test DAO class for entity class: Customer Customer - клиент
 */
...
public class TestCustomerDAO {
	...
	public void testGetAllEntitiesSingularAttributeOfTQSortOrderType()
		...
		List<Customer> list = dataStore.getAllEntities(Customer_.id,
				SortOrderType.ASC);
	...
	public void testGetAllEntitiesBooleanIntIntSingularAttributeOfTQSortOrderType()
		...
		// all - FALSE
		List<Customer> list = dataStore.getAllEntities(false, 10, 10,
