...
/**
 * JUnit test service class for entity class: Division
 * Division - отделение
 */
...
public class TestDivisionService {
	...
	public void testGetAllEntitiesSingularAttributeOfTQSortOrderType()
		...
		List<Division> list = service.getAllEntities(Division_.id, SortOrderType.ASC);
	...
	public void testGetAllEntitiesBooleanIntIntSingularAttributeOfTQSortOrderType()
		...
		// all - FALSE
		List<Division> list = service.getAllEntities(false, 10, 10, Division_.id,
				SortOrderType.ASC);
