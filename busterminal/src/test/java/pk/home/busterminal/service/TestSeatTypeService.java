...
/**
 * JUnit test service class for entity class: SeatType
 * SeatType - тип места
 */
...
public class TestSeatTypeService {
	...
	public void testGetAllEntitiesSingularAttributeOfTQSortOrderType()
		...
		List<SeatType> list = service.getAllEntities(SeatType_.id, SortOrderType.ASC);
	...
	public void testGetAllEntitiesBooleanIntIntSingularAttributeOfTQSortOrderType()
		...
		// all - FALSE
		List<SeatType> list = service.getAllEntities(false, 10, 10, SeatType_.id,
				SortOrderType.ASC);
